...
module.setup = function(mason_servers, lsp_servers)
	...
	-- Diagnostic keymaps
	vim.keymap.set("n", "<leader>q", vim.diagnostic.setloclist, { desc = "Basic: open diagnostic quickfix list" })
	...
	vim.keymap.set("t", "<Esc><Esc>", "<C-\\><C-n>", { desc = "Basic: exit terminal mode" })

	-- Keybinds to make split navigation easier.
	--  Use CTRL+<hjkl> to switch between windows
	--
	--  See `:help wincmd` for a list of all window commands
	vim.keymap.set("n", "<C-h>", "<C-w><C-h>", { desc = "Basic: move focus to the left window" })
	vim.keymap.set("n", "<C-l>", "<C-w><C-l>", { desc = "Basic: move focus to the right window" })
	vim.keymap.set("n", "<C-j>", "<C-w><C-j>", { desc = "Basic: move focus to the lower window" })
	vim.keymap.set("n", "<C-k>", "<C-w><C-k>", { desc = "Basic: move focus to the upper window" })
	...
	require("lazy").setup({
		...
		{ -- Telescope Fuzzy Finder (files, lsp, etc)
			...
			config = function()
				...
				vim.keymap.set("n", "<leader>sh", builtin.help_tags, { desc = "Telescope: search in help" })
				...
				vim.keymap.set("n", "<leader>sb", builtin.buffers, { desc = "Telescope: search existing buffers" })
			end,
		},
