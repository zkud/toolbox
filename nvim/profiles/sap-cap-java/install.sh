...
copy_nvim_initial_config_to_home_cache $HOME/.toolbox/nvim/profiles/sap-cap-java

docker build -t $NVIM_SAP_CAP_JAVA_IMAGE_NAME \
  ...
  ~/.toolbox/nvim/profiles/sap-cap-java/ 
